...
%Original signal is 100Hz, upsampling 10 times to yield effective Fs = 1000Hz      
%As such from the 0 to 1 (normalized over 2pi) range there is now 10 copies
%of the original signal. 
%We only want one of that, so we put Wn = 0.1 -- retain a single copy
%aka the digital cutoff is 0.1pi over the 0-2pi range
